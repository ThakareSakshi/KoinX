...
const Tokenomics = () => {
  ...
  return (
    <div className="p-10 bg-white rounded-xl overflow-hidden my-4">
        <h2 className="text-2xl text-[#0F1629] font-semibold">Tokenomics</h2>
        ...
        Amet unde, minima odit fuga consequuntur error cupiditate doloribus voluptas sunt consequatur nisi dignissimos libero rerum deserunt obcaecati vel quos. Recusandae necessitatibus tenetur adipisci quibusdam? Ullam autem aperiam natus neque.</p>
